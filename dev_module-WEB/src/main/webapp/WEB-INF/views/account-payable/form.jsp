...
<script type="text/javascript"
	src="<c:url value="/js/account-receivable/ajax.js" />"></script>
					...
					<div class="field">
						...
						<div class="ui  left icon input">
							<form:input type="text"
								placeholder="Digite as iniciais do cliente" id="inp-cliente"
								path="cliente.nome"></form:input>
							<i class="user icon"></i> <input type="hidden"
								id="inp-cliente-id" data-type="id-cliente">
				...
				<div class="content">
					...
					<div class="fields">
						...
						<div class="eight wide field" style="display: none;"
							...
							<table class="ui very basic table" id="tbl-parcelas">
								<thead>
									<tr>
										<th align="center"></th>
