...
<div class="ui grid">
	<div class="four wide column">
		<div class="ui segment">
			<div class="field">
				<h4 class="ui black block header">Menu</h4>

				<a href="<c:url value="/account-payable/new" />"
					class="fluid ui green button">Nova Despesa</a>
	...
	<div class="twelve wide column">
		<div class="ui segment">
			<div class="field">
				<h4 class="ui black block header">Contas a Receber</h4>
